...
\\\\
Ričard Metju Stolmen (Slika b), osnivač GNU projekta\cite{gnu}, je uz svoj tim započeo izradu kompletnog operativnog sistema čija je glavna namena  bila da bude otvorena i slobodna alternativa za Unix. Jedina stvar koja je falila jeste kernel, sto je jezgro operativnog sistema koje služi da poveže sve druge komponente u celinu.
\\\\
...
\begin{figure}[h]
	\centering
    \subfloat[Ken Tompson i Denis Riči, tvorci Unix-a]{{\includegraphics[height=3cm,width=4cm]{ken-thompson-dennis-ritchie} }}
    \hspace{1cm}
    \subfloat[Ričard Metju Stolmen, tvorac GNU-a]{{\includegraphics[height=3cm,width=4cm]{richard-stallman} }}
    \hspace{1cm}
...
Postoje različite vrste kernela\cite{kernelcats}, neki su kompleksniji ali modularniji a neki su jednostavniji i brži.
\begin{itemize}
...
\subsubsection{Delovi Linux kernela}
Neki od osnovnih delova Linux kernela\cite{devibm}:
\begin{itemize}
...
Linux operativni sistem za svaki objekat, tj. fajl ili folder, ima određene dozvole. Moguće ih je videti komandom \textbf{ls -l}. Postoje tri vrste dozvola: čitanje, pisanje i pokretanje. Takođe postoje tri vrste vlasništva: vlasnik, grupa i svi ostali. Na ta tri vlasnišva se određuje koje dozvole imaju, koristeći sledeće brojeve (pored kojih je prikaz u binarnom sistemu radi lakšeg razumevanja):
\begin{itemize}
\item 0 - 000 - nema nikakvih dozvola
\item 1 - 001 - dozvola za pokretanje
\item 2 - 010 - dozvola za pisanje
\item 3 - 011 - dozvola za pokretanje i pisanje
\item 4 - 100 - dozvola za čitanje
\item 5 - 101 - dozvola za čitanje i pokretanje
\item 6 - 110 - dozvola za čitanje i pisanje
\item 7 - 111 - ima sve dozvole
\end{itemize}
